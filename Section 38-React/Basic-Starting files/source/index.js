...
const customStyle = {
  color: "red",                                          //js objects for inline styling. pass parameters as string 
  fontSize: "20px",
...
into a JavaScript file.
 ...
 <h1 className="heading" contentEditable="true" spellCheck="false">
    ...
    <h1 style={customStyle}>Hello World!</h1>                                        takes inline styles as js objects



    <h1 className="heading2" style={textColor}>
